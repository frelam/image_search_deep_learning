...
def search(indices,feat,feature_map,ID_map):
    ...
    for category in indices:
        if feature_table is None:
            ...
            if (feature_map[category]):
                feature_table = np.vstack((feature_table, feature_map[category]))
            if (ID_map[category]):
...
if __name__ == '__main__':
    ...
    categories = 27
    path_npy = '/home/scw4750/frelam_20161027/get_txt/path.npy'
    feat_npy = '/home/scw4750/frelam_20161027/get_txt/feat.npy'
    num_npy = '/home/scw4750/frelam_20161027/get_txt/num.npy'
    #1.1load net
...
#print(addr)
    ...
    re = path_array[QueryIDResult[0:10]]
