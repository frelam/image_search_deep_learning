...
def loaddatabase(feat_npy,num_npy,categories):
    ...
    for index,it in enumerate(feature_map):
        if it:
            print index 
            it = np.array(it)
            temp = cm.CUDAMatrix(it)
...
if __name__ == '__main__':
    ...
    categories = 28
    path_npy = '/home/scw4750/frelam_20161027/path_sp+zl.npy'
...
#print(addr)
    ...
    re = path_array[QueryIDResult[0:50]]
